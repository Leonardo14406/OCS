...
export class OpenAIClient {
   ...
   */
  async detectGender(name: string): Promise<GenderDetectionResult> {
    const prompt = `
...
`;
   ...
   */
  async classifyComplaint(description: string): Promise<ClassificationResult> {
    const prompt = `
...
`;
   ...
   */
  async paraphraseDescription(originalDescription: string): Promise<ParaphraseResult> {
    const prompt = `
...
`;
   ...
   */
  async generateResponse(context: string, userMessage: string, persona: string = 'Leoma'): Promise<string> {
    const prompt = `
