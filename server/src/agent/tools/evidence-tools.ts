...
export const evidenceTools: ChatCompletionTool[] = [
  {
    type: "function",
    function: {
...
export async function uploadEvidenceHandler(args: any, context: ToolContext): Promise<ToolResult> {
  try {
...
export async function attachEvidenceToComplaintHandler(args: any, context: ToolContext): Promise<ToolResult> {
  try {
...
export const evidenceToolHandlers = {
