...
exports.complaintToolHandlers = exports.complaintTools = void 0;
exports.extractContactInfoHandler = extractContactInfoHandler;
exports.createComplaintHandler = createComplaintHandler;
exports.updateComplaintDetailsHandler = updateComplaintDetailsHandler;
const client_1 = require("@prisma/client");
exports.complaintTools = [
    {
        type: "function",
        function: {
                ...
                properties: {
                    ...
                    updates: {
                        ...
                        properties: {
                            ...
                            priority: { type: "string", enum: Object.values(client_1.ComplaintPriority) }
                        }
                    }
                },
...
async function updateComplaintDetailsHandler(args, context) {
    try {
        ...
        if (updates.ministry)
            updateData.ministry = updates.ministry;
        if (updates.category)
...
//# sourceMappingURL=complaint-tools.js.map