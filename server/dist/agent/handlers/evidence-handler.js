...
exports.EvidenceHandler = void 0;
    ...
    async handle(sessionId, userMessage) {
        ...
        if (lowerMessage.includes('no') || lowerMessage.includes('skip') ||
            ...
            return {
                ...
                nextState: client_1.ConversationState.classification,
...
exports.EvidenceHandler = EvidenceHandler;
//# sourceMappingURL=evidence-handler.js.map